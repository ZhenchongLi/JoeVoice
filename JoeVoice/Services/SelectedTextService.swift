...
class SelectedTextService {
    ...
    private static let privatePasteboardType = NSPasteboard.PasteboardType("com.joeli.JoeVoice.transient")

    static func fetchSelectedText() -> String? {
        // Don't check for selected text within JoeVoice itself
        guard let frontmostApp = NSWorkspace.shared.frontmostApplication,
              frontmostApp.bundleIdentifier != "com.joeli.JoeVoice" else {
            return nil
        }
