            ...
            VStack(spacing: 16) {
                HStack(spacing: 16) {
                    ...
                    HStack(alignment: .lastTextBaseline, spacing: 8) {
                        Text(licenseViewModel.licenseState == .licensed ? "JoeVoice Pro" : "Upgrade to Pro")
                ...
                Text(licenseViewModel.licenseState == .licensed ?
                     "Thank you for supporting JoeVoice" :
                ...
                if case .licensed = licenseViewModel.licenseState {
                    HStack(spacing: 40) {
                        Button {
                            if let url = URL(string: "https://github.com/ZhenchongLi/JoeVoice/releases") {
                        ...
                        Button {
                            if let url = URL(string: "https://joevoice.com/docs") {
                                NSWorkspace.shared.open(url)
                            }
                        } label: {
                        ...
                        Button {
                            if let url = URL(string: "https://buymeacoffee.com/ZhenchongLi") {
                                NSWorkspace.shared.open(url)
                            }
                        } label: {
                            animatedTipJarItem()
        ...
        VStack(spacing: 40) {
            ...
            VStack(spacing: 20) {
                ...
                HStack(spacing: 12) {
                    ...
                    Button(action: {
                        if let url = URL(string: "https://polar.sh/ZhenchongLi/portal/request") {
                            NSWorkspace.shared.open(url)
                        }
                    }) {
        ...
        VStack(spacing: 32) {
            ...
            VStack(spacing: 24) {
                ...
                if licenseViewModel.activationsLimit > 0 {
                    ...
                    Text("You can use JoeVoice Pro on all your personal devices")
                        .font(.subheadline)
                        .foregroundStyle(.secondary)
                }
            }
