                    ...
                    if selectedFilter == .local {
                        HStack(spacing: 8) {
                            ...
                            InfoTip(
                                ...
                                message: "Add a custom fine-tuned whisper model to use with JoeVoice. Select the downloaded .bin file.",
                                learnMoreURL: "https://joevoice.com/docs/custom-local-whisper-models"
                            )
