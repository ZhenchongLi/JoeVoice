    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 24) {
                SettingsSection(
                    icon: "command.circle",
                    title: "JoeVoice Shortcuts",
                    subtitle: "Choose how you want to trigger JoeVoice"
                ) {
                ...
                SettingsSection(
                    ...
                    subtitle: "Additional shortcuts for JoeVoice"
                ) {
                    VStack(alignment: .leading, spacing: 18) {
                        ...
                        VStack(alignment: .leading, spacing: 12) {
                            HStack(spacing: 8) {
                                ...
                                InfoTip(
                                    ...
                                    message: "Use middle mouse button to toggle JoeVoice recording."
                                )
                            }
            ...
            HStack(spacing: 12) {
                ...
                if showWarning {
                    ...
                    Image(systemName: "exclamationmark.triangle.fill")
                        .foregroundColor(.red)
                        .help("Permission required for JoeVoice to function properly")
                }
            }
