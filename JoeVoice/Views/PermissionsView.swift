            ...
            VStack(spacing: 32) {
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 8) {
                        ...
                        Text("JoeVoice requires the following permissions to function properly")
                            .font(.system(size: 15))
                ...
                VStack(spacing: 16) {
                    ...
                    PermissionCard(
                        ...
                        description: "Set up a keyboard shortcut to use JoeVoice anywhere",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow JoeVoice to record your voice for transcription",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow JoeVoice to paste transcribed text directly at your cursor position",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow JoeVoice to understand context from your screen for transcript Enhancement",
