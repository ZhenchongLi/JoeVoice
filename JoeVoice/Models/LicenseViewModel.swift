...
class LicenseViewModel: ObservableObject {
    ...
    private func loadLicenseState() {
        ...
        if let licenseKey = userDefaults.licenseKey {
            ...
            if userDefaults.activationId != nil || !userDefaults.bool(forKey: "JoeVoiceLicenseRequiresActivation") {
        ...
        let hasLaunchedBefore = userDefaults.bool(forKey: "JoeVoiceHasLaunchedBefore")
        if !hasLaunchedBefore {
            // First launch - start trial automatically
            userDefaults.set(true, forKey: "JoeVoiceHasLaunchedBefore")
            startTrial()
            return
        }
    ...
    func openPurchaseLink() {
        if let url = URL(string: "https://joevoice.com/buy") {
    ...
    func validateLicense() async {
        ...
        do {
            ...
            if licenseCheck.requiresActivation {
                ...
                userDefaults.set(true, forKey: "JoeVoiceLicenseRequiresActivation")
                self.activationsLimit = limit
                
            } else {
                // This license doesn't require activation (unlimited devices)
                userDefaults.activationId = nil
                userDefaults.set(false, forKey: "JoeVoiceLicenseRequiresActivation")
    ...
    func removeLicense() {
        ...
        userDefaults.set(false, forKey: "JoeVoiceHasLaunchedBefore")  // Allow trial to restart
...
extension UserDefaults {
    var activationId: String? {
        get { string(forKey: "JoeVoiceActivationId") }
        set { set(newValue, forKey: "JoeVoiceActivationId") }
    }
}
